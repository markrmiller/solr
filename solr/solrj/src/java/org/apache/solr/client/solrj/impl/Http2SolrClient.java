...
public class Http2SolrClient extends SolrClient {
  ...
  public static final String DESTINATION_NODE_IS_NOT_PROVIDED = "Destination node is not provided!";
  public static final String GET_CAN_T_SEND_STREAMS = "GET can't send streams!";
  public static final String SOLR_V_2_REAL_PATH = "solr.v2RealPath";
  public static final String V_2 = "/____v2";
  public static final String UNSUPPORTED_METHOD = "Unsupported method: ";
  public static final String STREAM = "stream";
  public static final String EXPECTED_MIME_TYPE = "Expected mime type ";
  public static final String BUT_GOT = " but got ";
  public static final String COULD_NOT_PARSE_RESPONSE_WITH_ENCODING =
      "Could not parse response with encoding ";
  public static final String EXCEPTION_WITH_ERR_OBJECT = "ExceptionWithErrObject";
  ...
  public static final String SOLR_JETTY_SSL_VERIFY_CLIENT_HOST_NAME =
      "solr.jetty.ssl.verifyClientHostName";

  public static final String STREAM_TAG = "<stream>";
  public static final String CLOSE_STREAM_TAG = "</stream>";
  ...
  public OutStream initOutStream(String baseUrl, UpdateRequest updateRequest, String collection)
    ...
    boolean direct = Boolean.getBoolean("httpClientDirectBuffer");
    ByteBuffer buffer = bufferPool.acquire(httpClient.getRequestBufferSize(), direct);
    buffer.clear();
