...
public class HeatmapJsonFacet {
  ...
  public HeatmapJsonFacet(Map heatmapNL) {
   ...
   */
  public static boolean isHeatmapFacet(Map<String, Object> potentialHeatmapValues) {
    ...
    for (Map.Entry<String, Object> entry : potentialHeatmapValues.entrySet()) {
