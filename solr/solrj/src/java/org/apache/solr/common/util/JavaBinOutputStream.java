 ...
 */
public final class JavaBinOutputStream implements Closeable {
 ...
 // private long written;  // how many bytes written to the underlying stream
  ...
  public JavaBinOutputStream(OutputStream sink, byte[] tempBuffer, int start) {
    ...
    if (sink instanceof FastOutputStream) {
      ...
      if (tempBuffer != null) {
        throw new IllegalArgumentException("FastInputStream cannot bass a buffer to JavaBinInputStream");
      }
    } else {
