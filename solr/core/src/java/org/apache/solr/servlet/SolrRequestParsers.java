...
public class SolrRequestParsers {
  ...
  public final String INPUT_ENCODING_KEY = "ie";
  ...
  private RTimerTree getRequestTimer(HttpServletRequest req) {
  ...
  private SolrCall getHttpSolrCall(HttpServletRequest req) {
   ...
   * @param map         place all parameters in this map
   */
  @SuppressWarnings({"fallthrough", "resource"}) long parseFormDataContent(final InputStream postContent, final long maxLen, Charset charset, final Map<String,String[]> map, boolean supportCharsetParam) throws IOException {
  ...
  private String decodeChars(byte[] bytes, long position, CharsetDecoder charsetDecoder) {
    try {
  ...
  private void decodeBuffer(final LinkedList<Object> input, final Map<String,String[]> map, CharsetDecoder charsetDecoder) {
   ...
   */
  void cleanupMultipartFiles(MultiParts multiParts) {
  ...
  static class FormDataRequestParser implements SolrRequestParser {
    ...
    @Override public SolrParams parseParamsAndFillStreams(HttpServletRequest req, ArrayList<ContentStream> streams) throws Exception {
      if (!SolrRequestParsers.getInstance().isFormData(req)) {
  ...
  static class StandardRequestParser implements SolrRequestParsers.SolrRequestParser {
     ...
     */
    private SolrParams autodetect(HttpServletRequest req, ArrayList<ContentStream> streams, FastInputStream in) throws IOException {
