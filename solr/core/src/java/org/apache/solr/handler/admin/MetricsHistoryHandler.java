...
public class MetricsHistoryHandler extends RequestHandlerBase implements PermissionNameProvider, Closeable {
  ...
  private final Map<String, List<String>> counters = new NonBlockingHashMap<>(128);
  private final Map<String, List<String>> gauges = new NonBlockingHashMap<>(128);
  private final String overseerUrlScheme;

  private final Map<String, RrdDb> knownDbs = new NonBlockingHashMap<>(16);
