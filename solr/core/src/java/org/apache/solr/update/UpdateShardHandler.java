...
public class UpdateShardHandler implements SolrInfoBean {
  ...
  public UpdateShardHandler(UpdateShardHandlerConfig cfg) {
   ...
   // updateOnlyClient.addListenerFactory(updateHttpListenerFactory);
    ...
    leaderCheckClientBuilder = leaderCheckClientBuilder.connectionTimeout(5000).idleTimeout(20000);

    leaderCheckClient = leaderCheckClientBuilder.markInternalRequest().build();
