...
//  private volatile ExecutorService taskExecutor;
  ...
  public void start(String id, ElectionContext context, boolean weAreReplacement) throws KeeperException {
    startLock.lock();
    try {
      ...
      taskExecutor = ParWork.getExecutorService("OverseertaskExecutor", 10);

      zkWriterExecutor = ParWork.getExecutorService("zkWriterExecutor", 32);
