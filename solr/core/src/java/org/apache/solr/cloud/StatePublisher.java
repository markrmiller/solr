      ...
      while (!terminated) {
        ...
        try {
          try {
            ...
            log.warn("state publisher hit InterruptedException polling", e);
...
//            }
      ...
      if (stateMessage == TERMINATE_OP) {
        ...
        workQueue.offer(new ConcurrentHashMap(stateMessage));
      }
    } catch (Exception e) {
  ...
  public void start() {
    ...
    workerFuture = ParWork.submit("StatePublisher", this.worker);
  }
