...
public class ZkController implements Closeable, Runnable {
  ...
  private final Map<String, LeaderElector> leaderElectors = new NonBlockingHashMap<>(32);
...
//  };
  ...
  private final Map<String, ReplicateFromLeader> replicateFromLeaders = new NonBlockingHashMap<>(32);
  private final Map<String, ZkCollectionTerms> collectionToTerms = new NonBlockingHashMap<>(32);
  ...
  private final Map<String, Throwable> replicasMetTragicEvent = new NonBlockingHashMap<>(16);
...
//        });
  ...
  private ElectionContext getOverseerContext() {
    return new OverseerElectionContext(overseerElector, getHostPort(), zkClient, overseer);
  }
