...
//    filtOptThreshold = getFloat("query/boolTofilterOptimizer/@threshold",.05f);
    ...
    Map<String, CacheConfig> userCacheConfigs = CacheConfig.getMultipleConfigs(this, SolrResourceLoader.configXpathExpressions.queryCacheConfigsExp, "query/cache");
