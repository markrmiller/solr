...
public class ConfigXpathExpressions {
  ...
  public final static Map<String,XPathExpression> CACHE = new NonBlockingHashMap<>(64);
  ...
  private void addToCache(XPath xpath, String path) throws XPathExpressionException {
