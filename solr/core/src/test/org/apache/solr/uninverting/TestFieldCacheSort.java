...
public class TestFieldCacheSort extends SolrTestCase {
  ...
  public void testEmptyStringVsNullStringSort() throws Exception {
    Directory dir = SolrTestUtil.newDirectory();
    IndexWriter w = new IndexWriter(dir, LuceneTestCase.newIndexWriterConfig(new MockAnalyzer(LuceneTestCase.random())));
    Document doc = new Document();
  ...
  public void testMultiValuedField() throws IOException {
    ...
    IndexWriter writer = new IndexWriter(indexStore, LuceneTestCase.newIndexWriterConfig(new MockAnalyzer(LuceneTestCase.random())));
    for(int i=0; i<5; i++) {
        Document doc = new Document();
  ...
  public void testMaxScore() throws Exception {
    ...
    IndexWriter w = new IndexWriter(d, new IndexWriterConfig(new MockAnalyzer(LuceneTestCase.random())));
    int id = 0;
