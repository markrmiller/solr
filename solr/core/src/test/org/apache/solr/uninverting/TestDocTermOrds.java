...
public class TestDocTermOrds extends SolrTestCase {
  ...
  public void testEmptyIndex() throws IOException {
    ...
    final IndexWriter iw = new IndexWriter(dir, LuceneTestCase.newIndexWriterConfig(new MockAnalyzer(LuceneTestCase.random())));
    iw.close();
  ...
  public void testSimple() throws Exception {
    ...
    final RandomIndexWriter w = new RandomIndexWriter(LuceneTestCase.random(), dir, LuceneTestCase.newIndexWriterConfig(new MockAnalyzer(LuceneTestCase.random())).setMergePolicy(LuceneTestCase.newLogMergePolicy()));
  ...
  public void testRandom() throws Exception {
    ...
    IndexWriterConfig conf = LuceneTestCase.newIndexWriterConfig(new MockAnalyzer(LuceneTestCase.random()));
    ...
    final RandomIndexWriter w = new RandomIndexWriter(LuceneTestCase.random(), dir, conf);
  ...
  public void testSortedTermsEnum() throws IOException {
    ...
    RandomIndexWriter iwriter = new RandomIndexWriter(LuceneTestCase.random(), directory, iwconfig);
