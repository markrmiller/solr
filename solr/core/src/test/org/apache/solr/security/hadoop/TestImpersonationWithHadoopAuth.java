...
public class TestImpersonationWithHadoopAuth  extends SolrCloudTestCase {
  ...
  private static final boolean defaultAddRequestHeadersToContext =
      SolrRequestParsers.getDefaultInstance().isAddRequestHeadersToContext();
  ...
  public static void tearDownClass() throws Exception {
    SolrRequestParsers.getDefaultInstance().setAddRequestHeadersToContext(defaultAddRequestHeadersToContext);
