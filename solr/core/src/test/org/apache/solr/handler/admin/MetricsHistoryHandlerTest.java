...
public class MetricsHistoryHandlerTest extends SolrCloudTestCase {
  ...
  public static void beforeClass() throws Exception {
    ...
    handler = new MetricsHistoryHandler(cluster.getJettySolrRunner(0).getNodeName(), metricsHandler, solrClient, cloudManager, args,
        null);
    SolrMetricsContext solrMetricsContext = new SolrMetricsContext(metricManager, SolrInfoBean.Group.node.toString(), "", true);
    ...
    CollectionAdminRequest.Create create = CollectionAdminRequest.createCollection(CollectionAdminParams.SYSTEM_COLL, "conf", 1, 1);
