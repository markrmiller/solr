...
abstract public class RestTestBase extends SolrJettyTestBase {
  ...
  public static JettySolrRunner createJettyAndHarness
    ...
    Http2SolrClient client =  getHttpSolrClient(newJetty.getBaseUrl().toString() + "/" + DEFAULT_TEST_CORENAME);
    clients.add(client);
    ...
    restTestHarness = new RestTestHarness(() -> newJetty.getBaseUrl().toString() + "/" + DEFAULT_TEST_CORENAME, client, jettyLoader);
    jettys.add(newJetty);
    return newJetty;
  }
