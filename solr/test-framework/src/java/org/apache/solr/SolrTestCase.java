...
public class SolrTestCase extends Assert {
   ...
   */
  private final static long STATIC_LEAK_THRESHOLD = 1200; // MRM TODO: I dropped this down hard and enabled it again
  ...
  private static final AtomicReference<Random> RANDOM = new AtomicReference();
  ...
  public static Random random() {
    ...
    //return RANDOM.updateAndGet(random -> random == null ? LuceneTestCase.random() : random);
