...
public class SolrTestCase extends Assert {
  ...
  public static TestRule solrClassRules =
      RuleChain.outerRule(new RevertDefaultThreadHandlerRule()).around(classEnvRule = new TestRuleSetupAndRestoreClassEnv()).around(suiteFailureMarker = new TestRuleMarkFailure()).around(new SystemPropertiesRestoreRule())
...
//  })
  ...
  @Rule
  public TestRule solrTestRules = RuleChain.outerRule(new SystemPropertiesRestoreRule()).around(threadAndTestNameRule = new TestRuleThreadAndTestName()).around(parentChainCallRule = new TestRuleSetupTeardownChained());
