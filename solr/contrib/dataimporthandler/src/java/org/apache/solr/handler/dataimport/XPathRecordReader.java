...
public class XPathRecordReader {
  ...
  private static class Node {
     ...
     * Node object.
     */
    private static Node getMatchingNode(XMLStreamReader parser, List<Node> searchL){
      if (searchL == null)
        return null;
    ...
    private static boolean checkForAttributes(XMLStreamReader parser, List<Map.Entry<String,String>> attrs) {
    ...
    private static void putANull(String thisFieldName, Map<String,Object> values, Set<String> valuesAddedinThisFrame) {
    ...
    private static void putText(Map<String,Object> values, String value, String fieldName, boolean multiValued) {
      if (multiValued) {
