...
public class BottomFunction {
  ...
  public static final CreatorFunction creatorFunction = (params -> {
    ...
    if (param instanceof DateValueStream) {
      if (params.length == 1) {
        return LambdaFunction.createDateLambdaFunction(name, (a,b) -> Math.min(a, b), (DateValueStream)param);
      }
      ...
      if (!tryNextType) {
        return LambdaFunction.createDateLambdaFunction(name, (a,b) -> Math.min(a, b), castedParams, false);
      }
    }
    if (param instanceof IntValueStream) {
      if (params.length == 1) {
        return LambdaFunction.createIntLambdaFunction(name, (a,b) -> Math.min(a, b), (IntValueStream)param);
      }
      ...
      if (!tryNextType) {
        return LambdaFunction.createIntLambdaFunction(name, (a,b) -> Math.min(a, b), castedParams, false);
      }
    }
    if (param instanceof LongValueStream) {
      if (params.length == 1) {
        return LambdaFunction.createLongLambdaFunction(name, (a,b) -> Math.min(a, b), (LongValueStream)param);
      }
      ...
      if (!tryNextType) {
        return LambdaFunction.createLongLambdaFunction(name, (a,b) -> Math.min(a, b), castedParams, false);
      }
    }
    if (param instanceof FloatValueStream) {
      if (params.length == 1) {
        return LambdaFunction.createFloatLambdaFunction(name, (a,b) -> Math.min(a, b), (FloatValueStream)param);
      }
      ...
      if (!tryNextType) {
        return LambdaFunction.createFloatLambdaFunction(name, (a,b) -> Math.min(a, b), castedParams, false);
      }
    }
    if (param instanceof DoubleValueStream) {
      if (params.length == 1) {
        return LambdaFunction.createDoubleLambdaFunction(name, (a,b) -> Math.min(a, b), (DoubleValueStream)param);
      }
      ...
      if (!tryNextType) {
        return LambdaFunction.createDoubleLambdaFunction(name, (a,b) -> Math.min(a, b), castedParams, false);
      }
    }
