...
public class StatisticsEntry {
  ...
  public String toString() {
    return String.format(
        "%s (%s, %s%%): %s", name, count, percentage, StatisticsEntry.displayString(values));
  }
  ...
  public static String displayString(Object object) {
    ...
    if (object instanceof Collection) {
      ...
      String elements =
          collection.stream().map(StatisticsEntry::displayString).collect(Collectors.joining(", "));
    ...
    if (object.getClass().isArray()) {
      ...
      String elements =
          Arrays.stream(array)
              .map(StatisticsEntry::displayString)
